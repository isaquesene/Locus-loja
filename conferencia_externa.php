...
<?php  $justificativas = json_encode($justificativas); ?>
<div class="row"> 
	<div class="col-md-12"> 
				...
				<div class="panel-body"> 
					<div class="row"> 
						<div class="col-md-6 form-group">
							...
							<input type="text" class="form-control form-uppercase" name="form-chave" data-validate="required" data-message-required="Este campo é obrigatório." />
  ...
  swal({
    ...
    if (isConfirm) {
      ...
      swal({
		...
		var input_select = document.getElementsByClassName('classe-unica');
