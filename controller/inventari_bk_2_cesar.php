    ...
    public function tempoTemplate()
    {
        ...
        if (isset($_POST["Import"])) {
            ...
            if ($file_type === 'text/csv' || $file_type === 'application/vnd.ms-excel' && $file_ext === 'csv') {
                ...
                function geraCesta($divergencia,$naoMovimentados,$falteiros){
                    ...
                    return $this->Inventario_model->insere_cesta_nova($param);

                }

                echo "ID GERADO ".geraCesta($divergencia,$naoMovimentados,$falteiros);
                exit;
