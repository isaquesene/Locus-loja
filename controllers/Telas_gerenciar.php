...
class Telas_gerenciar extends CI_Controller 
{
	function __construct()
	{
        ...
        $tela  = 5; //Cod. da tela - Tabela t_telas
	...
	public function index()
	{
		...
		$data['dados_telas'] = $this->Telas_model->obtem_todas_telas();
		$this->load->view('telas_gerenciar', $data);
    }


	public function deletar()
	{	
		$tel_id = $this->uri->segment(3, 0);		
		if($this->Telas_model->deletar_tela($tel_id))
		{
            $data['msg_status']   = 'OK';
            $data['msg_texto']    = 'Tela Apagada com Sucesso.';  
        ...
        else
        {
            ...
            $data['msg_texto']    = 'Erro ao Apagar tela.';  
