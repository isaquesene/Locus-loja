...
class Chamados_resp_gerenciar extends CI_Controller 
{
	function __construct()
	{
        ...
        $tela  = 13; //Cod. da tela - Tabela t_telas
	...
	public function index()
	{
		...
		$data['dados_grid'] = $this->Chamados_model->obtem_todos_resp_chamados();
		$this->load->view('chamados_resp_gerenciar', $data);
	}
