...
class Relatorio_sobras extends CI_Controller 
{
	function __construct()
	{
        ...
        $this->load->model('RelatorioSobras_model');
    ...
    private function consultar_relatorio(){
        ...
        $data['dados_relatorio'] = $this->RelatorioSobras_model->obtem_dados_relatorio($form_data_inicio,$form_data_final);
        $data['info'] = true;
    }

        $this->load->view('relatorio_sobras', $data);
    }
