...
class Chamados_msg_gerenciar extends CI_Controller 
{
	function __construct()
	{
        ...
        $tela  = 12; //Cod. da tela - Tabela t_telas
	...
	public function index()
	{
		...
		$data['dados_grid'] = $this->Chamados_model->obtem_todos_msg_chamados();
		$this->load->view('chamados_msg_gerenciar', $data);
	}
