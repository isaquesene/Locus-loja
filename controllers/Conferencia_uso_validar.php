...
class conferencia_uso_validar extends CI_Controller
{
        ...
        if (!$chave) {
            ...
            if ($controlados[0]->cont > 0) {
                ...
                if ($possuiControladosNulos) {
                    ...
                    $data['dados_nota']         = $this->Conferencia_model->obtem_dados_nota_uso($filial, $chave);
                ...
                $this->load->view('conferencia_uso_validar', $data);
            }
        }
    }
