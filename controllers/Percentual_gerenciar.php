...
class Percentual_gerenciar extends CI_Controller 
{
	...
	public function index()
	{
		...
		$data['dados_perc'] = $this->Percentual_model->obtem_dados_percentual();
		$this->load->view('percentual_gerenciar', $data);
    }
    
    public function deletar(){
        $conf_id = $this->uri->segment(3,0);
        if($this->Percentual_model->deletar_percentual($conf_id)){
                $data['msg_status']   = 'OK';
