...
class Menus_gerenciar extends CI_Controller 
{
	function __construct()
	{
        ...
        $tela  = 3; //Cod. da tela - Tabela t_telas
	...
	public function index()
	{
		...
		$data['dados_menus'] = $this->Telas_model->obtem_todos_menus();
		$this->load->view('menus_gerenciar', $data);
    }

	public function deletar()
	{	
		$men_id = $this->uri->segment(3, 0);		
		if($this->Telas_model->deletar_menu($men_id))
		{
            $data['msg_status']   = 'OK';
            $data['msg_texto']    = 'Menu Apagado com Sucesso.';  
        ...
        else
        {
            ...
            $data['msg_texto']    = 'Erro ao Apagar Menu.';  
