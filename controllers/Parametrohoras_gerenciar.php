...
class Parametrohoras_gerenciar extends CI_Controller 
{
	function __construct()
	{
        ...
        $tela  = 52; //Cod. da tela - Tabela t_telas
	...
	public function index()
	{
		...
		$data['dados_parametrohoras'] = $this->Parametrohoras_model->obtem_dados_conferencia_obrigatoria();
		$this->load->view('parametrohoras_gerenciar', $data);
    }
